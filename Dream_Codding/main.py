...
class Game:
    def __init__(self):
        ...
        self.font_path = "Dream_Codding/assets/font.ttf"
        self.background = pygame.image.load("Dream_Codding/bg1.png").convert()
        self.background_scaled = pygame.transform.scale(self.background, (SCREEN_WIDTH, SCREEN_HEIGHT))

        # Músicas
        self.menu_tutorial_music = "Dream_Codding/Audio/Anemoia - Chimeric.mp3"  # Música para menu e tutorial
        self.game_music = "Dream_Codding/Audio/Bggm.mp3"  # Música para o jogo
    ...
    def draw_menu(self):
        ...
        while self.state == "menu":
            ...
            # Botões
            play_button = Button(
                image=pygame.image.load("Dream_Codding/assets/Play Rect.png"),
            ...
            options_button = Button(
                image=pygame.image.load("Dream_Codding/assets/Options Rect.png"),
            ...
            quit_button = Button(
                image=pygame.image.load("Dream_Codding/assets/Quit Rect.png"),
    ...
    def draw_cinematic(self,start_time):
        ...
        if self.state == "inicio":
            if pygame.time.get_ticks() - start_time < 4000:
                imagem = pygame.image.load("Dream_Codding/cinematic/1.png")
                self.screen.blit(imagem,(0,0))
            elif pygame.time.get_ticks() -start_time< 10000:
                imagem = pygame.image.load("Dream_Codding/cinematic/2.png")
                self.screen.blit(imagem,(0,0))
            elif pygame.time.get_ticks() -start_time< 17000:
                imagem = pygame.image.load("Dream_Codding/cinematic/3.png")
                self.screen.blit(imagem,(0,0))
            elif pygame.time.get_ticks() -start_time< 20000:
                imagem = pygame.image.load("Dream_Codding/cinematic/4.png")
                self.screen.blit(imagem,(0,0))
            else:
                self.score = 0
                self.text = ''
            ...
            imagem = pygame.image.load("Dream_Codding/cinematic/5.png")
            self.screen.blit(imagem,(0,0))
