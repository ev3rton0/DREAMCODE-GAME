...
class Level:
    ...
    def __init__(self):
        ...
        # Carregar uma imagem
        self.image = pygame.image.load('Dream_Codding/Mapa/tilesets/DREAMCODE mapa.png').convert_alpha()
        #Pega a superficie
    ...
    def setup(self):
        #Mapa
        tmx_data = load_pygame('Dream_Codding/Mapa/tilesets/DREAMCODE mapa.tmx')
